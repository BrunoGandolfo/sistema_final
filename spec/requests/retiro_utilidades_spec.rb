...
RSpec.describe "RetiroUtilidades API", type: :request do
  ...
  # Parámetros inválidos (violando validaciones del modelo)
  let(:invalid_attributes) do
    {
      fecha: nil,              # Fecha es obligatoria
      tipo_cambio: -5,         # Tipo de cambio debe ser mayor que 0
      sucursal: "",            # Sucursal es obligatoria
      monto_uyu: "invalido",   # Debe ser numérico
      monto_usd: "invalido"    # Debe ser numérico
    }
  end
